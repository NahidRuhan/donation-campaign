//https://github.com/rahathossenantor/donation-campaign

import { PieChart, Pie, Cell } from "recharts";
import { getDonation } from "../../utils/localStorage";

const Statistics = () => {
    const donatedCards = getDonation();
    ...
    const data = [
        { name: "Your Donations", value: donatedCards.length / 12 },
        { name: "Total Donations", value: 1 - (donatedCards.length / 12) },
      ];
